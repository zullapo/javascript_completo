...
var Todo = /*#__PURE__*/(0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__.default)(function Todo(title) {
  ...
  var updatedAt = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : new Date();

  (0,_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_3__.default)(this, Todo);
...
getAddress('03133000').then(function (r) {
  console.log(r);
})["catch"](function (e) {
  console.log(e);
});
